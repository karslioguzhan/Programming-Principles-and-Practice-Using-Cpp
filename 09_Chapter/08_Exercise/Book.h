...
private:
	...
	gerne gerneBook;
public:
	Book(ISBN inputISBN, std::string inputTitle, Date inputDate, std::string inputAuthor, bool inputIsCheckedOut, gerne inputGerne);
	ISBN getISBN10() const;
	void setISBN10(ISBN newISBN10);
	std::string getGerne() const;
	void setGerne(gerne inputGerne);
